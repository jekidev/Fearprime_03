...
| Wright et al. (2024), [EMDR versus andre terapier, IPD-metaanalyse](https://doi.org/10.1017/S0033291723003446) | Systematisk review fandt 15 RCT'er; 8 bidrog med individuelle deltagerdata (346 deltagere) | Ingen signifikant forskel mellem EMDR og de inkluderede psykologiske terapier for symptomsværhedsgrad, respons, remission eller frafald. | Lille IPD-undergruppe suhteutettuna 15 relevante forsøg; abstractets betaestimater mangler CI:t. Ikke evidens for ækvivalens. |
