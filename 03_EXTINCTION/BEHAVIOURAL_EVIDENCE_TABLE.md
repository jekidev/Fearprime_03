...
|---|---|---|---|
| Schnurr et al. (2022), [PE vs CPT](../07_STUDIES/VERIFIED/2022_Schnurr_PE_CPT_Multisite_RCT.md) | Multisite RCT; 916 amerikanske veteraner med militærrelateret PTSD; 10–14 individuelle sessioner | Begge grupper forbedredes. PE havde større gennemsnitlig CAPS-5-forbedring end CPT, men forskellen (2,42 point; 95% CI 0,53–4,31) lå under den prædefinerede kliniske betydningstærskel. På WHO-DAS-II var præ-post-SMD 0,11 i begge arme og PE–CPT-SMD 0,03; artiklen fandt ingen forskel mellem behandlingerne på funktion eller livskvalitet. Frafald var højere ved PE (55,8%) end CPT (46,6%). | Funktion og livskvalitet var sekundære, ikke-forhåndsregistrerede mål; selvrapporteret funktion er ikke direkte adfærdsobservation. Aktiv sammenligning uden ubehandlet kontrol; mekanismen er ikke isoleret. |
| Moshier et al. (2024), [session-level symptomreanalyse](https://doi.org/10.1037/ccp0000880) | Sekundær session-for-session-analyse af samme PE–CPT-forsøg; de samme 916 veteraner | PE var forbundet med større fald fra første til sidste session i 10 individuelle PCL-5-symptomscorer. Undgåelsesrelaterede behandlingsforskelle var tydeligst tidligt i forløbet. | PCL-5-symptomer er selvrapport, ikke direkte måling af faktisk tilnærmelse, undgåelse eller funktion. Samme sample; ikke en uafhængig replikation. Numeriske effekter og CI er ikke udtrukket. |
| Ito et al. (2025), [CPT og funktion i Japan](../07_STUDIES/VERIFIED/2025_Ito_CPT_Function_Japan_RCT.md) | Enkeltcenter, assessor-blindet RCT; 60 japanske voksne ambulante patienter med PTSD; CPT+TAU (n=29) vs venteliste+TAU (n=31) | Patientrapporteret SDS-funktionsnedsættelse ved uge 17 viste en forskel i ændring på 8,16 point (95% CI 3,90–12,43) til fordel for CPT+TAU. Forfatterne rapporterede fortsat forbedring i funktion frem til uge 34. | Alle sekundære analyser var eksplorative. SDS er selvrapport, ikke direkte adfærdsobservation. Ét center, lille sample, ventelistekontrol, 90% kvinder; blinding fejlede ved uge 17 og 34, og farmakoterapiændringer var ikke begrænset. Ingen direkte måling af tilnærmelse eller undgåelse. |
...
5. Den målrettede gennemgang har nu registreret selvrapporterede funktionsmål i Schnurr et al. (2022) og Ito et al. (2025), samt en PCL-5-symptomreanalyse af Schnurr-kohorten. Ito-forsøget fandt en eksplorativ forskel på SDS ved uge 17, men SDS er selvrapporteret funktion og ikke direkte observeret adfærd. Moshier-analysen måler symptomer i samme 916-personers kohorte, ikke faktisk tilnærmelse eller undgåelse. Næste evidensopgave er en reproducerbar søgning efter uafhængige forsøg med direkte adfærdsmål, funktion og opfølgning; reanalyser skal knyttes til forældresamplet.
...
- Moshier, S. J. et al. (2024). [Session-level effects of CPT and PE on individual PTSD symptoms](https://pubmed.ncbi.nlm.nih.gov/38546622/). *Journal of Consulting and Clinical Psychology*, 92(7), 422–431. DOI: [10.1037/ccp0000880](https://doi.org/10.1037/ccp0000880). Reanalysis of the same parent RCT cohort; not an independent sample.
- Ito, M. et al. (2025). [Cognitive Processing Therapy for PTSD in Japan](https://doi.org/10.1001/jamanetworkopen.2024.58059). *JAMA Network Open*, 8(2), e2458059. Single-center RCT; SDS functional outcome was exploratory and patient-reported.
