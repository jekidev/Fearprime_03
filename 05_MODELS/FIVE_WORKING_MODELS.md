# Fem arbejdsmodeller for FearPrime
Version 0.2 · 2026-09-15

Modellerne omsætter projektets adaptive forståelse til spørgsmål, observationer og beslutninger. De er projektdesign (E), ikke fem validerede behandlingsprotokoller. Forskningsgrundlaget findes i [studiesamlingen](../07_STUDIES/STUDY_LEDGER.md). Et beskyttende formål betyder ikke, at enhver trusselstolkning er korrekt.

## 1. Kalibrering: Hvad beskytter alarmen imod?
**Formål:** Skelne mellem konkret fare, usikkerhed og en indlært alarm i en aktuelt sikker situation.
**Arbejdsgang:**
1. Vælg én tilbagevendende hverdagssituation.
2. Beskriv observerbare forhold uden at slutte noget om andre menneskers hensigter.
3. Skriv alarmens forudsigelse og mindst én alternativ forklaring.
4. Notér både tegn på fare og tegn på sikkerhed.
5. Vælg en lille, men meningsfuld handling i en situation uden konkret fare.
...
**Formål:** Gøre eksponering til en afgrænset læringsopgave.
**Arbejdsgang:**
1. Skriv én observerbar forudsigelse og sandsynlighed 0–100.
2. Vælg et håndterbart trin; opgaven skal teste forudsigelsen.
3. Beskriv på forhånd, hvornår opgaven er udført.
4. Gennemfør den og registrér udfaldet.
5. Sammenlign det forventede med det observerede.
...
Traumefokuserede terapier som PE, CPT og EMDR har klinisk støtte; det validerer ikke automatisk dette selvudviklede skema. Kilde: [VA's terapioverblik](https://www.ptsd.va.gov/professional/treat/txessentials/overview_therapy.asp).

## 3. Fastholdelse: Kan læringen bruges senere?
**Formål:** Adskille umiddelbar lettelse fra vedvarende læring.
**Arbejdsgang:**
1. Efter model 2 noteres én konkret læringssætning.
2. Planlæg en sammenlignelig, sikker opgave cirka næste dag og cirka syv dage senere.
3. Registrér forventningen før hver ny opgave.
4. Notér søvn, sygdom, koffein og ændringer i behandling som mulige forklaringer.
5. Sammenlign handling og forventning på tværs af tid.
...
## 4. Generalisering: Holder læringen uden for én situation?
**Formål:** Undersøge hvor situationsbundet en forbedring er.
**Arbejdsgang:**
1. Start med en opgave, der allerede er håndterbar.
2. Skift én kontekstfaktor: tidspunkt, sted eller social sammenhæng.
3. Bevar selve opgaven tilstrækkeligt ens til at kunne sammenligne.
4. Notér forventning og handling i den nye kontekst.
