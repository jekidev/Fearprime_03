...
## Direkte humane fund
### Ribbens 2026
180 raske deltagere, seks randomiserede, tredobbeltblindede grupper. Enkelt oral dosis 4 g natriumbutyrat, 30 minutter før eller umiddelbart efter udslukning; kort/lang træning. Genkaldelse efter syv dage forbedredes på forventningsmålet ved lang træning, ikke i hovedanalysens SCR eller ved genaktivering efter uvarslet ubehag.

| Kontrast på differentiel forventning om ubehag | Rapporteret Cohen's d | Justeret p |
|---|---:|---:|
| Før vs. placebo, begge træningslængder | 0,37 | 0,042 |
| Efter vs. placebo, begge træningslængder | 0,47 | 0,020 |
| Før vs. placebo, lang udslukning | 0,76 | 0,010 |
| Efter vs. placebo, lang udslukning | 0,98 | <0,001 |

Holm-korrektion blev anvendt. Ingen signifikant før/efter-forskel dokumenterer ikke ækvivalens. Kort/lang-manipulationen gav ikke den tilsigtede forskel i placebo-fastholdelse. Mekanismen blev ikke målt neurobiologisk. Tallene er modelbaserede laboratoriekontraster, ikke PTSD-behandlingseffekter; konfidensintervaller er ikke udtrukket her. Supplementet er ikke fuldt gennemgået.

[Primærartikel](https://www.nature.com/articles/s41380-026-03802-1), DOI 10.1038/s41380-026-03802-1. Dosis er studiedata, ikke anbefaling.

### Dalile 2024 — anden formulering og tidsplan
71 raske mænd; randomiseret, tredobbeltblindet placebo-kontrol. Resuméet angiver 5,28 g butyrat dagligt i en uge via pH-afhængige kolonfrigivende kapsler. Serum-butyrat steg; frygthukommelse blev påvirket subjektivt, ikke fysiologisk. Akut subjektiv/neuroendokrin stressrespons blev ikke forbedret. Resuméet giver ikke tilstrækkelige detaljer til her at kvantificere eller ensrette hukommelseseffektens retning.

Det er ikke en replikation af det akutte design. Gramangivelsen gengives som forfatterne skriver den; kemisk massebasis må kontrolleres i fuldteksten før omregning.
...
I mus gav SerBut større systemisk tilgængelighed og højere målte butyratniveauer i blandt andet **hjerne og rygmarv**. I autoimmune/inflammatoriske musemodeller reducerede SerBut sygdomsgrad og neuroinflammatoriske/immune mål, og i flere sammenligninger klarede SerBut sig bedre end molært ækvivalent frit natriumbutyrat eller serin alene.

**FearPrime-fortolkning:** Studiet viser, at formulering kan ændre butyrats distribution markant, inklusive CNS-eksponering i mus. Det er ikke et fear-extinction- eller PTSD-studie og kan ikke bruges som bevis for, at almindeligt natriumbutyrat hos mennesker når de samme hjernekoncentrationer eller hæmmer HDAC2 i relevante kredsløb.
...
| Felt | Hvorfor det er nødvendigt |
|---|---|
...
| Molekylært mål | Butyrat i blod/hjerne er ikke i sig selv dokumenteret HDAC2/PV/PNN-målaktivering |
...
formulering → systemisk/central eksponering
                    ↓
            muligt molekylært mål
                    ↓
          kredsløbs-/plasticitetsændring
                    ↓
