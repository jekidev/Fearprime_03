...
| Systemisk eksponering | Isotopsporing eller serumkoncentration | Koncentrationens tidsforløb efter den konkrete formulering |
| Central eksponering | Ikke fastlagt af ovenstående forsøg | Hvor meget når relevante hjerneområder? |
...
| Klinisk funktion | Ikke etableret af disse forsøg | PTSD-resultater og holdbarhed |
...
- **Kemisk form:** natriumbutyrat, andre salte og estere er forskellige kemiske former.
- **Formulering:** overtræk, matrix og hjælpestoffer kan ændre frigivelsen; ordet mikroindkapslet dokumenterer ikke et bestemt frigivelsessted.
- **Eksponering:** faktisk koncentration over tid skal måles. Samme gramangivelse dokumenterer ikke samme eksponering.

Tributyrin kan ikke tildeles samme kliniske eller farmakokinetiske evidens som natriumbutyrat alene ud fra indholdet af butyratgrupper. Denne revision har ikke kontrolleret et direkte humant sammenligningsforsøg.
...
2. Human koncentrationskurve for netop formuleringen.
3. Relevant central målaktivering; perifert BDNF er ikke i sig selv et mål for lokal TrkB-aktivering.
4. Tidsmæssig sammenhæng mellem målaktivering og senere læring.
5. Design, der skelner HDAC/BDNF-forklaringen fra andre virkningsveje.
