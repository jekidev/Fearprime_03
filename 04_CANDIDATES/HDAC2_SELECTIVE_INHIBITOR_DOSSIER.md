...
Dette dokument er et forskningskort. Ingen af forbindelserne nedenfor er dokumenteret som behandling for PTSD hos mennesker.
...
## 5. Santacruzamate A / CAY10683 — vigtig negativ kontrol
...
## 6. Direkte extinction-comparator: RGFP963
...
## 7. Butyrat versus selektive værktøjer
...
Der er nu tre forskellige spørgsmål, som FearPrime ikke må blande sammen:
...
3. **Er HDAC2/PV/Acan/PNN den mediator, der forklarer forbedret extinction?** — Lavertu-Jolin 2023 støtter dette i mus med BRD6688/genetik, men den humane kæde er ikke vist.
...
4. **Compound 17** — brain penetrant, men for begrænset isoform-selektivitet.
5. **RGFP963** — direkte extinction-signal, men HDAC1/2/3-bredt.
6. **Butyrat** — mest relevant human translationalt, men bred HDAC-biokemi.
7. **Santacruzamate A/CAY10683** — ikke anvendelig som valideret HDAC2-probe efter replikationsproblemer.
